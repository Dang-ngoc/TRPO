...
namespace TRPO
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            linkLabel1.Click += new EventHandler(this.OpenExample);
            linkLabel2.Click += new EventHandler(this.ClearAll);
            dataGridView2.ReadOnly = true;
            dataGridView3.ReadOnly = true;
        }
        private void OpenExample(object sender, EventArgs args)
        {
            Form2 f = new Form2();
            f.ShowDialog();
        }
        ...
        {
           var result= MessageBox.Show("Вы точно хотите удалить все данные?", "Внимание!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void minItemColumnProcessor(object sender, EventArgs args)
        {
            ...
            try
            {
                ...
                lblInfor.Text = "Базисный план = " + SumBasic.ToString();
            }
            catch (Exception)
            {
                MessageBox.Show("Введены некорректные данные", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void MethodSquareProcessor(object sender, EventArgs args)
        {
            try
            {
                ...
                lblInfor.Text = "Базисный план = " + SumBasic.ToString() + "\nОптимальный план =" + SumOpt.ToString() ;
